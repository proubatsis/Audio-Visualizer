...
///
/// \brief A variant of the BarVisualizer where the bars are arranged in a circle and the bars extend outwards from the circle.
///
...
protected:
	...
	float _barCountMultiplier;	///< How many more bars are needed vs the minimum?
